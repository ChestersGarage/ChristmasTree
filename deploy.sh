...
ssh pi@192.168.1.125 "git -C /home/pi/ChristmasTree pull; killall -9q python3; sudo killall -9q fcserver-rpi"
...
ssh pi@192.168.1.125 "nohup python3 /home/pi/ChristmasTree/christmas_tree.py > /home/pi/christmas_tree.log 2>&1 &"
