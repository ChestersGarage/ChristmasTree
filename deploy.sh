...
ssh pi@192.168.1.125 "git -C /home/pi/ChristmasTree pull; killall -q python3; killall -q fcserver-rpi"
ssh pi@192.168.1.125 "nohup /root/fcserver-rpi /home/pi/ChristmasTree/server.json > /home/pi/fcserver.log 2>&1 &"
